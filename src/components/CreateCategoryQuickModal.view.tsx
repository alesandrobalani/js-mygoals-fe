interface CreateCategoryQuickModalViewProps {
  name: string;
  description: string;
  submitting: boolean;
  error: string;
...
export function CreateCategoryQuickModalView({
  name,
  description,
  submitting,
  error,
  ...
  onSubmit,
  onClose,
}: CreateCategoryQuickModalViewProps) {
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6">
        <h3 className="text-base font-semibold text-slate-800 mb-4">Nova Categoria</h3>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="cat-description" className="block text-sm font-medium text-slate-700 mb-1">
              Descrição
            </label>
            <input
              id="cat-description"
